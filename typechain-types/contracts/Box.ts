...
export interface BoxInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "retriece", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "retriece", data: BytesLike): Result;
...
export interface Box extends BaseContract {
  ...
  retriece: TypedContractMethod<[], [bigint], "view">;
